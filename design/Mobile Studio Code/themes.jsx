// Theme tokens for all 5 design languages.
// Every page reads from `useTheme()` -> a flat token bag.
// Switching themes only swaps tokens; layout stays the same.
...
const THEMES = {
  glass: {
    ...
    radius: 24,
    fontUI: '-apple-system, "SF Pro Text", system-ui',
  ...
  terminal: {
    ...
    borderColor: '#1f2430',
    radius: 4,
    fontUI: '"JetBrains Mono", "SF Mono", ui-monospace, monospace',
  ...
  paper: {
    ...
    borderColor: '#e6dfd0',
    radius: 6,
    fontUI: 'ui-serif, "Iowan Old Style", Georgia, serif',
    fontMono: '"iA Writer Mono", ui-monospace, Menlo, monospace',
...
const ThemeCtx = React.createContext(THEMES.glass);
