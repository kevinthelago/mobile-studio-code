...
const styles = StyleSheet.create({
  ...
  chevronPlaceholder: { width: 14 },
  treeIcon: { width: 18, alignItems: 'center' },
  treeName: { flex: 1, fontSize: 13.5, color: theme.fg },
  treeNameActive: { color: theme.accent, fontWeight: '600' },
  treeNameFolder: { fontWeight: '500' },
  treeSize: { fontSize: 11, color: theme.fgDim, fontFamily: 'monospace' },
});
