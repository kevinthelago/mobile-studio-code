...
export function PlannerSyncProvider({ children }: { children: React.ReactNode }) {
  // TODO(PT1): tunnel-mobile will add syncRequestManifest/syncPull/syncPush/setSyncManifestHandler
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const { connectionState, syncRequestManifest, syncPull, syncPush, setSyncManifestHandler } = useTunnel() as any;
  ...
  useEffect(() => {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    setSyncManifestHandler((projects: any) => {
